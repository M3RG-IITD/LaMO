...
parser.add_argument('--model', type=str, default='LaMO_Irregular_Mesh_shared')
...
parser.add_argument('--save_name', type=str, default='LaMO_Elas')
parser.add_argument('--data_path', type=str, default='data/Meshes')
...
def main():
    ...
    PATH_Sigma = args.data_path + '/Random_UnitCell_sigma_10.npy'
    PATH_XY = args.data_path + '/Random_UnitCell_XY_10.npy'
